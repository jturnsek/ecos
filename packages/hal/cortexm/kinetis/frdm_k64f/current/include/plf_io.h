...
#define CYGHWR_IO_FREESCALE_SPI0_PIN_SCK  CYGHWR_HAL_KINETIS_PIN(D, 1, 2, KINETIS_PIN_SPI0_OUT_OPT)
#define CYGHWR_IO_FREESCALE_SPI0_PIN_CS0  CYGHWR_HAL_KINETIS_PIN(D, 0, 2, KINETIS_PIN_SPI0_CS_OPT)
#define CYGHWR_IO_FREESCALE_SPI0_PIN_CS1  CYGHWR_HAL_KINETIS_PIN(D, 4, 2, KINETIS_PIN_SPI0_CS_OPT)
#define CYGHWR_IO_FREESCALE_SPI0_PIN_CS2  CYGHWR_HAL_KINETIS_PIN(D, 5, 2, KINETIS_PIN_SPI0_CS_OPT)
#define CYGHWR_IO_FREESCALE_SPI0_PIN_CS3  CYGHWR_HAL_KINETIS_PIN(D, 6, 2, KINETIS_PIN_SPI0_CS_OPT)
