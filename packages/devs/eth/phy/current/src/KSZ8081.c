...
//      dev/KSZ8081.c
//
//      Ethernet transceiver (PHY) support for Micrel KSZ8081
//
//==========================================================================
...
// Original data: Uwe Kindler <uwe_kindler@web.de>
// Date:          2015-12-15
// Purpose:
// Description:  Support for ethernet PHY Micrel KSZ8081
//
//
//####DESCRIPTIONEND####
//
...
void
ksz8081_diag (eth_phy_access_t * f)
{

  cyg_uint32 i;
  cyg_uint16 reg;

  eth_phy_printf ("KSZ8081 MIIM Register setings:\n");
...
static bool
ksz8081_stat (eth_phy_access_t * f, int *state)
{
...
_eth_phy_dev ("Micrel KSZ8081", 0x00221560, ksz8081_stat);
