#ifndef CYGONCE_DEVS_FLASH_SPI_MX25LXX_H
#define CYGONCE_DEVS_FLASH_SPI_MX25LXX_H
...
externC struct cyg_flash_dev_funs cyg_devs_flash_spi_mx25lxx_funs;

//-----------------------------------------------------------------------------
// Macro used to generate a flash device object with the default MX25LXX 
...
#define CYG_DEVS_FLASH_SPI_MX25LXX_DRIVER(_name_, _start_, _spidev_) \
struct cyg_flash_block_info _name_ ##_block_info; \
CYG_FLASH_DRIVER(_name_, &cyg_devs_flash_spi_mx25lxx_funs, 0, \
  _start_, _start_, 1, & _name_ ##_block_info, (void*) _spidev_)

//=============================================================================

#endif // CYGONCE_DEVS_FLASH_SPI_MX25LXX_H
